...
Hexadecimal [16-Bits]
                             ...
                             27 ;; CYCLES: []
                             28 ;;==================================================================
   671C                      29 _su_add_score:
                             30 
   671C FD 7E 1B      [19]   31     ld a, _ep_score_du(iy)
   671F 83            [ 4]   32     add e
   6720 C6 00         [ 7]   33     add #0x00
   6722 27            [ 4]   34     daa
   6723 FD 77 1B      [19]   35     ld _ep_score_du(iy), a
                             36 
   6726 FD 7E 1A      [19]   37     ld a, _ep_score_mc(iy)
   6729 8A            [ 4]   38     adc d
   672A C6 00         [ 7]   39     add #0x00
   672C 27            [ 4]   40     daa
   672D FD 77 1A      [19]   41     ld _ep_score_mc(iy), a
   6730 30 0A         [12]   42     jr nc, as_add_score_end
                             43 
   6732 FD 7E 19      [19]   44     ld a, _ep_score_cdm(iy)
   6735 3C            [ 4]   45     inc a
   6736 C6 00         [ 7]   46     add #0x00
   6738 27            [ 4]   47     daa 
   6739 FD 77 19      [19]   48     ld _ep_score_cdm(iy), a
                             49 
                             50 
   673C                      51 as_add_score_end:
                             52 
   673C 3E 01         [ 7]   53     ld a, #0x01
   673E CD F4 62      [17]   54     call _sr_update_hud_player_data
                             55 
   6741 C9            [10]   56     ret
...
Hexadecimal [16-Bits]
                             ...
                             79 ;; CYCLES: []
                             80 ;;==================================================================
   6742                      81 _su_get_key_input:
                             82 
   6742 21 CA 79      [10]   83     ld hl, #p1_key_gameplay     ;;Ponemos el actual_key en el previous_key
   6745 CB 26         [15]   84     sla (hl)                
                             85 
   6747 21 CB 79      [10]   86     ld hl, #p2_key_gameplay
   674A CB 26         [15]   87     sla (hl)
                             88 
   674C 76            [ 4]   89     halt
   674D CD 5A 75      [17]   90     call cpct_scanKeyboard_asm
                             91 
   6750 11 00 00      [10]   92     ld de, #0x0000
                             93     
   6753 CD 4C 6C      [17]   94     call cpct_isAnyKeyPressed_f_asm
   6756 FE 00         [ 7]   95     cp #0x00
   6758 C8            [11]   96     ret z
                             97 
   6759 D9            [ 4]   98     exx
                             99 
                            100 ;;Comprobar P1_key_r
   675A 2A CC 79      [16]  101     ld hl, (p1_key_r)
   675D CD B7 69      [17]  102     call cpct_isKeyPressed_asm
   6760 28 03         [12]  103     jr z, gki_check_p1_l
                            104 
   6762 D9            [ 4]  105         exx
   6763 14            [ 4]  106         inc d
   6764 D9            [ 4]  107         exx
   ...
   6765                     111 gki_check_p1_l:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 19.
Hexadecimal [16-Bits]



   6765 2A CE 79      [16]  112     ld hl, (p1_key_l)
   6768 CD B7 69      [17]  113     call cpct_isKeyPressed_asm
   676B 28 03         [12]  114     jr z, gki_check_p1_j
                            115 
   676D D9            [ 4]  116         exx
   676E 15            [ 4]  117         dec d
   676F D9            [ 4]  118         exx
   ...
   6770                     122 gki_check_p1_j:
   6770 2A D0 79      [16]  123     ld hl, (p1_key_j)
   6773 CD B7 69      [17]  124     call cpct_isKeyPressed_asm
   6776 28 05         [12]  125     jr z, gki_check_p2_r
                            126 
   6778 21 CA 79      [10]  127         ld hl, #p1_key_gameplay
   677B CB C6         [15]  128         set 0, (hl)
                            129 
                            130 
                            131 ;;Comprobar P2_key_r
   677D                     132 gki_check_p2_r:
   677D 2A D2 79      [16]  133     ld hl, (p2_key_r)
   6780 CD B7 69      [17]  134     call cpct_isKeyPressed_asm
   6783 28 03         [12]  135     jr z, gki_check_p2_l
                            136 
   6785 D9            [ 4]  137         exx
   6786 1C            [ 4]  138         inc e
   6787 D9            [ 4]  139         exx
   ...
   6788                     142 gki_check_p2_l:
   6788 2A D4 79      [16]  143     ld hl, (p2_key_l)
   678B CD B7 69      [17]  144     call cpct_isKeyPressed_asm
   678E 28 03         [12]  145     jr z, gki_check_p2_j
                            146 
   6790 D9            [ 4]  147         exx
   6791 1D            [ 4]  148         dec e
   6792 D9            [ 4]  149         exx
   ...
   6793                     152 gki_check_p2_j:
   6793 2A D6 79      [16]  153     ld hl, (p2_key_j)
   6796 CD B7 69      [17]  154     call cpct_isKeyPressed_asm
   6799 28 07         [12]  155     jr z, gki_check_pause
                            156 
   679B 21 CB 79      [10]  157         ld hl, #p2_key_gameplay
   679E CB C6         [15]  158         set 0, (hl)
   67A0 18 0C         [12]  159         jr gki_exit
                            160 
                            161 
   67A2                     162 gki_check_pause:
   67A2 21 08 04      [10]  163     ld hl, #Key_Esc
   67A5 CD B7 69      [17]  164     call cpct_isKeyPressed_asm
   67A8 28 04         [12]  165     jr z, gki_exit
   67AA 3E 01         [ 7]  166         ld a, #0x01
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 20.
Hexadecimal [16-Bits]



   67AC 18 01         [12]  167         jr gki_pause_exit
                            168 
   67AE                     169 gki_exit:
   67AE AF            [ 4]  170     xor a
   67AF                     171 gki_pause_exit:
   67AF D9            [ 4]  172     exx
   67B0 C9            [10]  173     ret
                            174 
                            175 
                            ...
                            194 ;; CYCLES: []
                            195 ;;==================================================================
   67B1                     196 _su_get_menu_key_input:
                            197 
                            198     ;; Escanear teclado
   67B1 76            [ 4]  199     halt
   67B2 CD 5A 75      [17]  200     call cpct_scanKeyboard_asm
                            201 
   67B5 AF            [ 4]  202     xor a
   67B6 CD 4C 6C      [17]  203     call cpct_isAnyKeyPressed_f_asm
   67B9 FE 00         [ 7]  204     cp #0x00
   67BB C8            [11]  205     ret z
                            206 
                            207     ;;Comprobar teclas pulsadas (las que nos interesan)
   67BC                     208     gmki_check_1:
   67BC 21 08 01      [10]  209     ld hl, #Key_1
   67BF CD B7 69      [17]  210     call cpct_isKeyPressed_asm
   67C2 28 03         [12]  211     jr z, gmki_check_2
   67C4 3E 01         [ 7]  212         ld a, #0x01
   67C6 C9            [10]  213         ret
                            214     
   67C7                     215     gmki_check_2:
   67C7 21 08 02      [10]  216     ld hl, #Key_2
   67CA CD B7 69      [17]  217     call cpct_isKeyPressed_asm
   67CD 28 03         [12]  218     jr z, gmki_check_3
   67CF 3E 02         [ 7]  219         ld a, #0x02
   67D1 C9            [10]  220         ret
                            221         
...
Hexadecimal [16-Bits]
   ...
   67D2                     222     gmki_check_3:
   67D2 21 07 02      [10]  223     ld hl, #Key_3
   67D5 CD B7 69      [17]  224     call cpct_isKeyPressed_asm
   67D8 28 03         [12]  225     jr z, gmki_check_4
   67DA 3E 03         [ 7]  226         ld a, #0x03
   67DC C9            [10]  227         ret
                            228     
   67DD                     229     gmki_check_4:
   67DD 21 07 01      [10]  230     ld hl, #Key_4
   67E0 CD B7 69      [17]  231     call cpct_isKeyPressed_asm
   67E3 28 03         [12]  232     jr z, gmki_check_5
   67E5 3E 04         [ 7]  233         ld a, #0x04
   67E7 C9            [10]  234         ret
                            235     
   67E8                     236     gmki_check_5:
   67E8 21 06 02      [10]  237     ld hl, #Key_5
   67EB CD B7 69      [17]  238     call cpct_isKeyPressed_asm
   67EE 28 03         [12]  239     jr z, gmki_check_6
   67F0 3E 05         [ 7]  240         ld a, #0x05
   67F2 C9            [10]  241         ret
                            242     
   67F3                     243     gmki_check_6:
   67F3 21 06 01      [10]  244     ld hl, #Key_6
   67F6 CD B7 69      [17]  245     call cpct_isKeyPressed_asm
   67F9 28 03         [12]  246     jr z, gmki_check_7
   67FB 3E 06         [ 7]  247         ld a, #0x06
   67FD C9            [10]  248         ret
                            249     
   67FE                     250     gmki_check_7:
   67FE 21 05 02      [10]  251     ld hl, #Key_7
   6801 CD B7 69      [17]  252     call cpct_isKeyPressed_asm
   6804 28 03         [12]  253     jr z, gmki_check_8
   6806 3E 07         [ 7]  254         ld a, #0x07
   6808 C9            [10]  255         ret
                            256     
   6809                     257     gmki_check_8:
   6809 21 05 01      [10]  258     ld hl, #Key_8
   680C CD B7 69      [17]  259     call cpct_isKeyPressed_asm
   680F 28 03         [12]  260     jr z, gmki_check_9
   6811 3E 09         [ 7]  261         ld a, #0x09
   6813 C9            [10]  262         ret
                            263 
   6814                     264     gmki_check_9:
   6814 21 04 02      [10]  265     ld hl, #Key_9
   6817 CD B7 69      [17]  266     call cpct_isKeyPressed_asm
   681A 28 03         [12]  267     jr z, gmki_check_default 
   681C 3E 09         [ 7]  268         ld a, #0x09
   681E C9            [10]  269         ret
                            270 
   681F                     271     gmki_check_default:
   681F 21 05 80      [10]  272     ld hl, #Key_Space
   6822 CD B7 69      [17]  273     call cpct_isKeyPressed_asm
   6825 28 03         [12]  274     jr z, gmki_check_back
   6827 3E 0A         [ 7]  275         ld a, #0x0A
   6829 C9            [10]  276         ret
...
Hexadecimal [16-Bits]
                            ...
                            277 
   682A                     278     gmki_check_back:
   682A 21 08 04      [10]  279     ld hl, #Key_Esc
   682D CD B7 69      [17]  280     call cpct_isKeyPressed_asm
   6830 28 03         [12]  281     jr z, gmki_no_input
   6832 3E 0B         [ 7]  282         ld a, #0x0B
   6834 C9            [10]  283         ret
                            284     
   6835                     285     gmki_no_input:
   6835 AF            [ 4]  286     xor a
                            287 
   6836 C9            [10]  288     ret
                            289 
                            ...
                            307 ;; CYCLES: []
                            308 ;;==================================================================
   6837                     309 _su_reset_data:
                            310 
   6837 FD 21 11 7A   [14]  311     ld iy, #player_1
   683B 06 02         [ 7]  312     ld b, #0x02
   683D AF            [ 4]  313     xor a
   683E                     314     rd_players_loop:
   683E FD 77 19      [19]  315     ld _ep_score_cdm(iy), a
   6841 FD 77 1B      [19]  316     ld _ep_score_du(iy), a
   6844 FD 77 1A      [19]  317     ld _ep_score_mc(iy), a
   6847 FD 77 1C      [19]  318     ld _ep_deaths_mc(iy), a
   684A FD 77 1D      [19]  319     ld _ep_deaths_du(iy), a
   684D FD 21 31 7A   [14]  320     ld iy, #player_2
   6851 05            [ 4]  321     dec b
   6852 20 EA         [12]  322     jr nz, rd_players_loop
                            323     
   6854 32 BE 79      [13]  324     ld (actual_level), a
                            325     
   6857 32 0A 7A      [13]  326     ld (timer_state), a
   685A 32 0B 7A      [13]  327     ld (seconds_dc), a
   685D 32 0C 7A      [13]  328     ld (seconds), a
   6860 32 0D 7A      [13]  329     ld (minutes), a
                            330 
                            331     
...
Hexadecimal [16-Bits]
   ...
   6863 21 DC 75      [10]  332     ld hl, #level_index
   6866 06 02         [ 7]  333     ld b, #NUM_LEVELS
   6868                     334     rd_levels_loop:
   6868 23            [ 6]  335         inc hl
   6869 23            [ 6]  336         inc hl
   686A 77            [ 7]  337         ld (hl), a
   686B 23            [ 6]  338         inc hl
   686C 23            [ 6]  339         inc hl
                            340 
   686D 05            [ 4]  341     dec b
   686E 20 F8         [12]  342     jr nz, rd_levels_loop
                            343 
   6870 32 C7 79      [13]  344     ld (checkpoint_level), a
                            345 
   6873 3E 10         [ 7]  346     ld a, #0x10
   6875 32 C5 79      [13]  347     ld (checkpoint_x), a
   6878 3E A7         [ 7]  348     ld a, #0xA7
   687A 32 C6 79      [13]  349     ld (checkpoint_y), a
                            350     
                            351 
   687D C9            [10]  352     ret
                            353 
                            ...
                            375 ;; CYCLES: []
                            376 ;;==================================================================
   687E                     377 _su_get_key_pressed:
                            378 
                            379     ;; Escanear teclado
   687E 76            [ 4]  380     halt
   687F CD 5A 75      [17]  381     call cpct_scanKeyboard_asm
                            382 
   6882 AF            [ 4]  383     xor a
   6883 CD 4C 6C      [17]  384     call cpct_isAnyKeyPressed_f_asm
   6886 FE 00         [ 7]  385     cp #0x00
   6888 3F            [ 4]  386     ccf
...
Hexadecimal [16-Bits]
   ...
   6889 C8            [11]  387     ret z
                            388 
                            389 
   688A 21 A6 6B      [10]  390     ld hl, #_cpct_keyboardStatusBuffer
                            391     ;; Iterar sobre el keyboard status buffer para sacar la tecla pulsada
   688D                     392     cka_keyboard_loop:
   688D 1E 00         [ 7]  393     ld e, #0x00
   688F                     394     lines_loop:
   688F 7E            [ 7]  395         ld a, (hl)
   6890 16 01         [ 7]  396         ld d, #0x01
                            397         
                            398 
   6892                     399         bits_loop:
   6892 CB 3F         [ 8]  400             srl a
   6894 D0            [11]  401             ret nc
   6895 CB 22         [ 8]  402             sla d
   6897 30 F9         [12]  403         jr nc, bits_loop
                            404 
   6899 23            [ 6]  405     inc hl
   689A 1C            [ 4]  406     inc e
   689B FE 0A         [ 7]  407     cp #0x0A
   689D 20 F0         [12]  408     jr nz, lines_loop
                            409 
   ...
   68A0 C9            [10]  413     ret
                            ...
                            431 ;; CYCLES: []
                            432 ;;==================================================================
   68A1                     433 _su_set_player_keys:
                            434 
   68A1 3E 03         [ 7]  435     ld a, #0x03
   68A3                     436     spk_keys_loop:
   68A3 F5            [11]  437         push af
   68A4 E5            [11]  438         push hl
                            439 
                            440         
   68A5 11 C1 76      [10]  441         ld de, #om_rightkey
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 25.
Hexadecimal [16-Bits]



   68A8 FE 03         [ 7]  442         cp #0x03
   68AA 28 0C         [12]  443         jr z, spk_draw_action
                            444         
   68AC                     445         spk_check_left_action:
   68AC FE 02         [ 7]  446         cp #0x02
   68AE 20 05         [12]  447         jr nz, spk_check_jump_action
   68B0 11 CC 76      [10]  448             ld de, #om_leftkey
   68B3 18 03         [12]  449             jr spk_draw_action
                            450 
   68B5                     451         spk_check_jump_action:
   68B5 11 D7 76      [10]  452         ld de, #om_jumpkey
                            453 
   68B8                     454         spk_draw_action:
   68B8 3A BB 79      [13]  455         ld a, (mg_front_buffer)
   68BB 21 34 0C      [10]  456         ld hl, #OM_RIGHTKEY_POS
   68BE CD 8C 63      [17]  457         call _sr_draw_string
                            458 
   68C1                     459         spk_key_loop:
   68C1 CD 7E 68      [17]  460             call _su_get_key_pressed
   68C4 38 FB         [12]  461         jr c, spk_key_loop
                            462 
                            463         ;; Para que no se vuelva a pulsar otra tecla por error
   68C6 06 50         [ 7]  464         ld b, #0x50
   68C8 CD B0 6B      [17]  465         call cpct_waitHalts_asm
                            466 
                            467         ;; Comprobar si no es una tecla no permitida
   68CB AF            [ 4]  468         xor a
   68CC 21 08 04      [10]  469         ld hl, #Key_Esc
   68CF ED 52         [15]  470         sbc hl, de
   68D1 28 EE         [12]  471         jr z, spk_key_loop
                            472 
   68D3 AF            [ 4]  473         xor a
   68D4 21 04 40      [10]  474         ld hl, #Key_M
   68D7 ED 52         [15]  475         sbc hl, de
   68D9 28 E6         [12]  476         jr z, spk_key_loop
                            477 
   68DB E1            [10]  478         pop hl
   68DC 73            [ 7]  479         ld (hl), e
   68DD 23            [ 6]  480         inc hl
   68DE 72            [ 7]  481         ld (hl), d
   68DF 23            [ 6]  482         inc hl
                            483 
   68E0 F1            [10]  484         pop af
   68E1 3D            [ 4]  485         dec a
   68E2 20 BF         [12]  486     jr nz, spk_keys_loop
                            487 
   68E4 C9            [10]  488 ret
