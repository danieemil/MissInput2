...
Hexadecimal [16-Bits]
                             ...
                             24 ;; CYCLES: []
                             25 ;;==================================================================
   66B0                      26 _sa_manage_enemy_ai:
                             27     
   66B0 11 00 00      [10]   28     ld de, #0x0000
                             29 
   66B3 FD 7E 17      [19]   30     ld a, _ee_type(iy)
   66B6 FE 01         [ 7]   31     cp #ET_TURTLE
   66B8 28 09         [12]   32     jr z, _sa_enemy_turtle_behaviour
                             33 
   66BA FE 02         [ 7]   34     cp #ET_SAW
   66BC 28 1C         [12]   35     jr z, _sa_enemy_saw_behaviour
                             36 
   66BE FE 03         [ 7]   37     cp #ET_ROCK
   66C0 28 3C         [12]   38     jr z, _sa_enemy_rock_behaviour
                             39 
   66C2 C9            [10]   40     ret
                             41 
                             42 
...
Hexadecimal [16-Bits]
                             ...
                             60 ;; CYCLES: []
                             61 ;;==================================================================
   66C3                      62 _sa_enemy_turtle_behaviour:
                             63 
                             64 
   66C3 FD 56 04      [19]   65     ld d, _eph_vx(iy)
   66C6 FD 5E 05      [19]   66     ld e, _eph_vy(iy)
                             67 
   66C9 FD CB 07 5E   [20]   68     bit 3, _eph_attributes(iy)
   66CD 20 07         [12]   69     jr nz, etb_change_dir_x
   66CF FD CB 07 56   [20]   70         bit 2, _eph_attributes(iy)
   66D3 20 01         [12]   71         jr nz, etb_change_dir_x
   66D5 C9            [10]   72             ret
                             73 
   66D6                      74     etb_change_dir_x:
   66D6 AF            [ 4]   75         xor a
   66D7 92            [ 4]   76         sub d
   66D8 57            [ 4]   77         ld d, a
                             78 
   66D9 C9            [10]   79     ret
                            ...
                            100 ;; CYCLES: []
                            101 ;;==================================================================
   66DA                     102 _sa_enemy_saw_behaviour:
                            103 
   66DA FD 56 04      [19]  104     ld d, _eph_vx(iy)
   66DD FD 5E 05      [19]  105     ld e, _eph_vy(iy)
                            106 
   66E0 FD CB 07 5E   [20]  107     bit 3, _eph_attributes(iy)
   66E4 20 07         [12]  108     jr nz, esb_die
   66E6 FD CB 07 66   [20]  109         bit 4, _eph_attributes(iy)
   66EA 20 01         [12]  110         jr nz, esb_die
   66EC C9            [10]  111             ret
...
Hexadecimal [16-Bits]
                            ...
                            112 
   66ED                     113     esb_die:
   66ED FD 36 18 14   [19]  114         ld _ee_disabled(iy), #EE_SAW_DISABLED   ; Desactivamos al enemigo sierra
   66F1 FD 7E 19      [19]  115         ld a, _ee_origin_x(iy)                  ; Reposicionamos al enemigo en su posición de inicio
   66F4 FD 77 00      [19]  116         ld _eph_x(iy), a
   66F7 FD 7E 1A      [19]  117         ld a, _ee_origin_y(iy)
   66FA FD 77 01      [19]  118         ld _eph_y(iy), a
                            119 
   66FD C9            [10]  120     ret
                            121 
                            122 ;;==================================================================
                            ...
                            138 ;; CYCLES: []
                            139 ;;==================================================================
   66FE                     140 _sa_enemy_rock_behaviour:
                            141     
   66FE FD 56 04      [19]  142     ld d, _eph_vx(iy)
   6701 FD 5E 05      [19]  143     ld e, _eph_vy(iy)
                            144 
   6704 FD CB 07 5E   [20]  145     bit 3, _eph_attributes(iy)
   6708 20 01         [12]  146     jr nz, erb_die
   670A C9            [10]  147         ret
                            148 
   670B                     149     erb_die:
   670B FD 36 18 64   [19]  150         ld _ee_disabled(iy), #EE_ROCK_DISABLED  ; Desactivamos al enemigo rock
   670F FD 7E 19      [19]  151         ld a, _ee_origin_x(iy)                  ; Reposicionamos al enemigo en su posición de inicio
   6712 FD 77 00      [19]  152         ld _eph_x(iy), a
   6715 FD 7E 1A      [19]  153         ld a, _ee_origin_y(iy)
   6718 FD 77 01      [19]  154         ld _eph_y(iy), a
                            155 
   671B C9            [10]  156     ret
