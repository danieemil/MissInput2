...
Hexadecimal [16-Bits]
                              ...
                              3 .area _DATA
                              4 
   795B                       5 interactable_index::
   795B 67 79                 6     .dw #interactable_checkpoint        ;00
   795D 75 79                 7     .dw #interactable_double_jump       ;01
   795F 83 79                 8     .dw #interactable_gravity_up        ;02
   7961 91 79                 9     .dw #interactable_gravity_down      ;03
   7963 9F 79                10     .dw #interactable_collectable       ;04
   7965 AD 79                11     .dw #interactable_door              ;05
                             12 
                             13 
   7967                      14 interactable_checkpoint:
                             15 ;; Datos del interactuable
                             16 ;;       _w      _h   _attributes
   7967 03 0C 00             17     .db #0x03, #0x0C, #0b00000000
                             18 
                             19 ;;      _sprite
   796A 62 38                20     .dw #_checkpoint_top_spr_0
                             21 
                             22 ;;     _spr_w  _spr_h       _spr_size        _spr_ox  _spr_oy
   796C 01 04 04 01 00       23     .db #0x01,  #0x04, #SPR_CHECKPOINT_SIZE,  #0x01,   #0x00
                             24 
                             25 ;;       _anim_index
   7971 FE FE                26     .dw 0xFEFE
                             27 
                             28 ;;      _score      _type
   7973 00 01                29     .db #0x00, #EI_CHECKPOINT
                             30 
                             31 
   7975                      32 interactable_double_jump:
                             33 ;; Datos del interactuable
                             34 ;;       _w      _h   _attributes
   7975 04 0A 00             35     .db #0x04, #0x0A, #0b00000000
                             36 
                             37 ;;      _sprite
   7978 82 35                38     .dw #_double_jump_spr_0
                             39 
                             40 ;;     _spr_w  _spr_h       _spr_size         _spr_ox  _spr_oy
   797A 04 06 18 00 01       41     .db #0x04,  #0x06,    #SPR_DJUMP_SIZE,    #0x00,   #0x01
                             42 
                             43 ;;       _anim_index
   797F 02 79                44     .dw #anim_interactable_djump_active_power_up
                             45 
                             46 ;;      _score      _type
   7981 00 02                47     .db #0x00, #EI_DOUBLE_JUMP
                             48 
                             49 
   7983                      50 interactable_gravity_up:
                             51 ;; Datos del interactuable
                             52 ;;       _w      _h   _attributes
   7983 02 08 00             53     .db #0x02, #0x08, #0b00000000
                             54 
                             55 ;;      _sprite
   7986 FA 35                56     .dw #_gravity_spr_00
...
Hexadecimal [16-Bits]
                             ...
                             57 
                             58 ;;     _spr_w  _spr_h           _spr_size   _spr_ox  _spr_oy
   7988 02 08 10 00 00       59     .db #0x02,  #0x08,    #SPR_GPUP_SIZE,    #0x00,   #0x00
                             60 
                             61 ;;       _anim_index
   798D C6 78                62     .dw #anim_interactable_gravity_up_power_up
                             63 
                             64 ;;      _score      _type
   798F 00 03                65     .db #0x00, #EI_GRAVITY_UP
                             66 
                             67 
   7991                      68 interactable_gravity_down:
                             69 ;; Datos del interactuable
                             70 ;;       _w      _h   _attributes
   7991 02 08 00             71     .db #0x02, #0x08, #0b00000000
                             72 
                             73 ;;      _sprite
   7994 6A 36                74     .dw #_gravity_spr_07
                             75 
                             76 ;;     _spr_w  _spr_h     _spr_size         _spr_ox  _spr_oy
   7996 02 08 10 00 00       77     .db #0x02,  #0x08,    #SPR_GPUP_SIZE,    #0x00,   #0x00
                             78 
                             79 ;;       _anim_index
   799B E4 78                80     .dw #anim_interactable_gravity_down_power_up
                             81 ;;      _score      _type
   799D 00 04                82     .db #0x00, #EI_GRAVITY_DOWN
                             83 
   799F                      84 interactable_collectable:
                             85 ;; Datos del interactuable
                             86 ;;       _w      _h   _attributes
   799F 02 0D 00             87     .db #0x02, #0x0D, #0b00000000
                             88 
                             89 ;;      _sprite
   79A2 1A 35                90     .dw #_colectable_spr_0
                             91 
                             92 ;;     _spr_w  _spr_h           _spr_size         _spr_ox  _spr_oy
   79A4 02 0D 1A 00 00       93     .db #0x02,  #0x0D,    #SPR_COLLECTABLE_SIZE,    #0x00,   #0x00
                             94 
                             95 ;;       _anim_index
   79A9 1C 79                96     .dw anim_interactable_colectable
                             97 
                             98 ;;      _score      _type
   79AB 50 05                99     .db #0x50, #EI_COLLECTABLE
                            100 
                            101 
   79AD                     102 interactable_door:
                            103 ;; Datos del interactuable
                            104 ;;       _w      _h   _attributes
   79AD 02 0B 00            105     .db #0x02, #0x0B, #0b00000000
                            106 
                            107 ;;      _sprite
   79B0 F4 37               108     .dw #_door_spr_0
                            109 
                            110 ;;     _spr_w  _spr_h      _spr_size         _spr_ox  _spr_oy
   79B2 02 0B 16 00 00      111     .db #0x02,  #0x0B,    #SPR_DOOR_SIZE,    #0x00,   #0x00
...
Hexadecimal [16-Bits]
                            ...
                            112 
                            113 ;;       _anim_index
   79B7 FE FE               114     .dw #0xFEFE
                            115 
                            116 ;;      _score  _type
   79B9 00 06               117     .db #0x00, #EI_DOOR
