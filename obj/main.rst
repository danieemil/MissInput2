...
Hexadecimal [16-Bits]
                             ...
                             23 .include "man/manager_menu.h.s"
                              1 ;;DEPENDENCIAS
...
Hexadecimal [16-Bits]
                             ...
                             31 .area _DATA
                             32 
   75D3 5C 40 50 41 55 53    33 string:: .asciz "\@PAUSE\"
        45 5C 00
                             34 
                             35 ;;
                             ...
                             51 ;;
   4E57                      52 _main::
   4E57 31 00 80      [10]   53    ld sp, #0x8000
                             54 
   4E5A CD A5 74      [17]   55    call cpct_disableFirmware_asm
                             56 
                             57 
   4E5D CD 26 69      [17]   58    call _si_init_interruptions
                             59 
   4E60 0E 01         [ 7]   60    ld c, #0x01
   4E62 CD 67 6C      [17]   61    call cpct_setVideoMode_asm
                             62    
   4E65 21 DA 46      [10]   63    ld hl, #_g_palette
   4E68 11 04 00      [10]   64    ld de, #0x0004
   4E6B CD EE 69      [17]   65    call cpct_setPalette_asm
                             66    
   4E6E 21 10 0B      [10]   67    ld hl, #0x0B10
   4E71 CD 01 6A      [17]   68    call cpct_setPALColour_asm
                             69 
                             70    ;ld a, #GS_MULTIPLAYER
   4E74 3E 01         [ 7]   71    ld a, #GS_SINGLEPLAYER
   4E76 32 BD 79      [13]   72    ld (mg_game_state), a
                             73 
   4E79 CD 73 51      [17]   74    call _mm_main_menu_init
   4E7C CD D5 51      [17]   75    call _mm_main_menu_loop
                             76 
                             77    ;;call _mg_game_init
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 216.
Hexadecimal [16-Bits]



                             78    ;;call _mg_game_loop
