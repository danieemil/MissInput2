...
Hexadecimal [16-Bits]
                             ...
                             12 .area _DATA
                             13 
   7A51                      14 interactable_vector:: DefineInteractableVector interactable_vector, 10
                     0000     1     _c = 0
                              2     .rept 10
                              3         DefineInteractableDefault interactable_vector, \_c
                              4         _c = _c + 1
                              5     .endm
   7A51                       1         DefineInteractableDefault interactable_vector, \_c
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7A51                       2     DefineEntityInteractable interactable_vector0, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
   ...
   7A51 00 00                 3     .db 0x00, 0x00
   7A53 02 08                 4     .db 0x02, 0x08
   7A55 00 00                 5     .db 0x00, 0x00
   7A57 00                    6     .db #0x00           ;;Offset en X
   7A58 00                    7     .db 0b00000000
                     0008     8     interactable_vector0_ed_eph_size = . - interactable_vector0_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7A59 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7A5B 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7A5D 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7A5E 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7A60 00                    8     .db #0x00           ;; Previous Offset
   7A61 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7A63 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7A65 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7A66 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector0_ed_size = . - interactable_vector0_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7A67 00                    4     .db 0x00  ;;Score
   7A68 00                    5     .db 0x00
   7A69 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector0_size = . - interactable_vector0 ;; Saves the number of bytes that fills a DefineEntity
                     0001     2         _c = _c + 1
   7A6A                       1         DefineInteractableDefault interactable_vector, \_c
...
Hexadecimal [16-Bits]
                              ...
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7A6A                       2     DefineEntityInteractable interactable_vector1, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
   7A6A                       1 interactable_vector1:
   ...
   7A6A 00 00                 3     .db 0x00, 0x00
   7A6C 02 08                 4     .db 0x02, 0x08
   7A6E 00 00                 5     .db 0x00, 0x00
   7A70 00                    6     .db #0x00           ;;Offset en X
   7A71 00                    7     .db 0b00000000
                     0008     8     interactable_vector1_ed_eph_size = . - interactable_vector1_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7A72 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7A74 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7A76 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7A77 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7A79 00                    8     .db #0x00           ;; Previous Offset
   7A7A 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7A7C 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7A7E 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7A7F 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector1_ed_size = . - interactable_vector1_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7A80 00                    4     .db 0x00  ;;Score
   7A81 00                    5     .db 0x00
   7A82 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector1_size = . - interactable_vector1 ;; Saves the number of bytes that fills a DefineEntity
                     0002     2         _c = _c + 1
   7A83                       1         DefineInteractableDefault interactable_vector, \_c
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7A83                       2     DefineEntityInteractable interactable_vector2, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
   7A83                       1 interactable_vector2:
   ...
   7A83 00 00                 3     .db 0x00, 0x00
   7A85 02 08                 4     .db 0x02, 0x08
   7A87 00 00                 5     .db 0x00, 0x00
   7A89 00                    6     .db #0x00           ;;Offset en X
   7A8A 00                    7     .db 0b00000000
                     0008     8     interactable_vector2_ed_eph_size = . - interactable_vector2_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7A8B 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7A8D 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7A8F 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 81.
Hexadecimal [16-Bits]



   7A90 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7A92 00                    8     .db #0x00           ;; Previous Offset
   7A93 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7A95 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7A97 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7A98 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector2_ed_size = . - interactable_vector2_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7A99 00                    4     .db 0x00  ;;Score
   7A9A 00                    5     .db 0x00
   7A9B 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector2_size = . - interactable_vector2 ;; Saves the number of bytes that fills a DefineEntity
                     0003     2         _c = _c + 1
   7A9C                       1         DefineInteractableDefault interactable_vector, \_c
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7A9C                       2     DefineEntityInteractable interactable_vector3, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
   7A9C                       1 interactable_vector3:
   ...
   7A9C 00 00                 3     .db 0x00, 0x00
   7A9E 02 08                 4     .db 0x02, 0x08
   7AA0 00 00                 5     .db 0x00, 0x00
   7AA2 00                    6     .db #0x00           ;;Offset en X
   7AA3 00                    7     .db 0b00000000
                     0008     8     interactable_vector3_ed_eph_size = . - interactable_vector3_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7AA4 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7AA6 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7AA8 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7AA9 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7AAB 00                    8     .db #0x00           ;; Previous Offset
   7AAC 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7AAE 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7AB0 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7AB1 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector3_ed_size = . - interactable_vector3_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7AB2 00                    4     .db 0x00  ;;Score
   7AB3 00                    5     .db 0x00
   7AB4 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector3_size = . - interactable_vector3 ;; Saves the number of bytes that fills a DefineEntity
                     0004     2         _c = _c + 1
   7AB5                       1         DefineInteractableDefault interactable_vector, \_c
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7AB5                       2     DefineEntityInteractable interactable_vector4, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 82.
Hexadecimal [16-Bits]



   7AB5                       1 interactable_vector4:
   ...
   7AB5 00 00                 3     .db 0x00, 0x00
   7AB7 02 08                 4     .db 0x02, 0x08
   7AB9 00 00                 5     .db 0x00, 0x00
   7ABB 00                    6     .db #0x00           ;;Offset en X
   7ABC 00                    7     .db 0b00000000
                     0008     8     interactable_vector4_ed_eph_size = . - interactable_vector4_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7ABD 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7ABF 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7AC1 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7AC2 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7AC4 00                    8     .db #0x00           ;; Previous Offset
   7AC5 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7AC7 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7AC9 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7ACA 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector4_ed_size = . - interactable_vector4_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7ACB 00                    4     .db 0x00  ;;Score
   7ACC 00                    5     .db 0x00
   7ACD 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector4_size = . - interactable_vector4 ;; Saves the number of bytes that fills a DefineEntity
                     0005     2         _c = _c + 1
   7ACE                       1         DefineInteractableDefault interactable_vector, \_c
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7ACE                       2     DefineEntityInteractable interactable_vector5, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
   7ACE                       1 interactable_vector5:
   ...
   7ACE 00 00                 3     .db 0x00, 0x00
   7AD0 02 08                 4     .db 0x02, 0x08
   7AD2 00 00                 5     .db 0x00, 0x00
   7AD4 00                    6     .db #0x00           ;;Offset en X
   7AD5 00                    7     .db 0b00000000
                     0008     8     interactable_vector5_ed_eph_size = . - interactable_vector5_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7AD6 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7AD8 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7ADA 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7ADB 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7ADD 00                    8     .db #0x00           ;; Previous Offset
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 83.
Hexadecimal [16-Bits]



   7ADE 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7AE0 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7AE2 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7AE3 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector5_ed_size = . - interactable_vector5_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7AE4 00                    4     .db 0x00  ;;Score
   7AE5 00                    5     .db 0x00
   7AE6 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector5_size = . - interactable_vector5 ;; Saves the number of bytes that fills a DefineEntity
                     0006     2         _c = _c + 1
   7AE7                       1         DefineInteractableDefault interactable_vector, \_c
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7AE7                       2     DefineEntityInteractable interactable_vector6, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
   7AE7                       1 interactable_vector6:
   ...
   7AE7 00 00                 3     .db 0x00, 0x00
   7AE9 02 08                 4     .db 0x02, 0x08
   7AEB 00 00                 5     .db 0x00, 0x00
   7AED 00                    6     .db #0x00           ;;Offset en X
   7AEE 00                    7     .db 0b00000000
                     0008     8     interactable_vector6_ed_eph_size = . - interactable_vector6_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7AEF 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7AF1 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7AF3 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7AF4 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7AF6 00                    8     .db #0x00           ;; Previous Offset
   7AF7 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7AF9 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7AFB 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7AFC 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector6_ed_size = . - interactable_vector6_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7AFD 00                    4     .db 0x00  ;;Score
   7AFE 00                    5     .db 0x00
   7AFF 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector6_size = . - interactable_vector6 ;; Saves the number of bytes that fills a DefineEntity
                     0007     2         _c = _c + 1
   7B00                       1         DefineInteractableDefault interactable_vector, \_c
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7B00                       2     DefineEntityInteractable interactable_vector7, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
   7B00                       1 interactable_vector7:
...
Hexadecimal [16-Bits]
   ...
   7B00 00 00                 3     .db 0x00, 0x00
   7B02 02 08                 4     .db 0x02, 0x08
   7B04 00 00                 5     .db 0x00, 0x00
   7B06 00                    6     .db #0x00           ;;Offset en X
   7B07 00                    7     .db 0b00000000
                     0008     8     interactable_vector7_ed_eph_size = . - interactable_vector7_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7B08 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7B0A 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7B0C 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7B0D 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7B0F 00                    8     .db #0x00           ;; Previous Offset
   7B10 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7B12 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7B14 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7B15 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector7_ed_size = . - interactable_vector7_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7B16 00                    4     .db 0x00  ;;Score
   7B17 00                    5     .db 0x00
   7B18 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector7_size = . - interactable_vector7 ;; Saves the number of bytes that fills a DefineEntity
                     0008     2         _c = _c + 1
   7B19                       1         DefineInteractableDefault interactable_vector, \_c
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7B19                       2     DefineEntityInteractable interactable_vector8, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
   7B19                       1 interactable_vector8:
   ...
   7B19 00 00                 3     .db 0x00, 0x00
   7B1B 02 08                 4     .db 0x02, 0x08
   7B1D 00 00                 5     .db 0x00, 0x00
   7B1F 00                    6     .db #0x00           ;;Offset en X
   7B20 00                    7     .db 0b00000000
                     0008     8     interactable_vector8_ed_eph_size = . - interactable_vector8_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7B21 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7B23 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7B25 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7B26 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7B28 00                    8     .db #0x00           ;; Previous Offset
   7B29 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7B2B 00 00                10     .dw 0x0000     ;; Puntero a la animación
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 85.
Hexadecimal [16-Bits]



   7B2D 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7B2E 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector8_ed_size = . - interactable_vector8_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7B2F 00                    4     .db 0x00  ;;Score
   7B30 00                    5     .db 0x00
   7B31 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector8_size = . - interactable_vector8 ;; Saves the number of bytes that fills a DefineEntity
                     0009     2         _c = _c + 1
   7B32                       1         DefineInteractableDefault interactable_vector, \_c
                              1 ;                                            x     y     w     h     vx    vy   attributes  sprite   sw    sh    ss    ox    oy   animi   score  type
   7B32                       2     DefineEntityInteractable interactable_vector9, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00, 0x00
   7B32                       1 interactable_vector9:
   ...
   7B32 00 00                 3     .db 0x00, 0x00
   7B34 02 08                 4     .db 0x02, 0x08
   7B36 00 00                 5     .db 0x00, 0x00
   7B38 00                    6     .db #0x00           ;;Offset en X
   7B39 00                    7     .db 0b00000000
                     0008     8     interactable_vector9_ed_eph_size = . - interactable_vector9_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7B3A 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7B3C 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7B3E 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7B3F 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7B41 00                    8     .db #0x00           ;; Previous Offset
   7B42 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7B44 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7B46 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7B47 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     interactable_vector9_ed_size = . - interactable_vector9_ed ;; Saves the number of bytes that fills a DefineEntity
                              3     
   7B48 00                    4     .db 0x00  ;;Score
   7B49 00                    5     .db 0x00
   7B4A 00                    6     .db #0x00   ;;Disabled
                              7 
                              8 
                     0019     9     interactable_vector9_size = . - interactable_vector9 ;; Saves the number of bytes that fills a DefineEntity
                     000A     2         _c = _c + 1
   7B4B 00                   15 mi_num_interactable:: .db #00
   7B4C 00                   16 mi_next_interactable_l: .db #00
   7B4D 00                   17 mi_next_interactable_h: .db #00
                             18 
                             19 
                             20 .area _CODE
                             21 
...
Hexadecimal [16-Bits]
                             ...
                             40 ;; CYCLES: [ | ]
                             41 ;;==================================================================
   55E1                      42 _mi_search_vector:
                             43 
   55E1 DD 21 51 7A   [14]   44     ld ix, #interactable_vector
                             45 
   55E5 21 4B 7B      [10]   46     ld hl, #mi_num_interactable
                             47 
   55E8 BE            [ 7]   48     cp (hl)
   55E9 30 0C         [12]   49     jr nc, sv_interactable_not_found
   55EB FE 00         [ 7]   50     cp #0x00
   55ED C8            [11]   51     ret z
                             52 
   55EE 01 19 00      [10]   53     ld bc, #_ei_size
   55F1                      54 sv_loop:
                             55 
   55F1 DD 09         [15]   56     add ix, bc
   55F3 3D            [ 4]   57     dec a
   55F4 20 FB         [12]   58     jr nz, sv_loop
                             59 
   55F6 C9            [10]   60     ret
                             61 
   55F7                      62 sv_interactable_not_found:
   55F7 AF            [ 4]   63     xor a
   55F8 3D            [ 4]   64     dec a
   55F9 C9            [10]   65     ret
                             66 
...
Hexadecimal [16-Bits]
                             ...
                             84 ;; CYCLES: [ | ]
                             85 ;;==================================================================
   55FA                      86 _mi_init_vector:
                             87     
   55FA 21 4B 7B      [10]   88     ld hl, #mi_num_interactable
   55FD 36 00         [10]   89     ld (hl), #0x00
                             90 
   55FF 21 51 7A      [10]   91     ld hl, #interactable_vector
   5602 22 4C 7B      [16]   92     ld (mi_next_interactable_l), hl
                             93 
   5605 C9            [10]   94     ret
                             95 
                             96 
                            ...
                            114 ;; CYCLES: [ | ]
                            115 ;;==================================================================
   5606                     116 _mi_add_interactable:
                            117     
   5606 C5            [11]  118     push bc
                            119 
   5607 21 5B 79      [10]  120     ld hl, #interactable_index
   560A CB 27         [ 8]  121     sla a
                            122 
   560C 4F            [ 4]  123     ld c, a
   560D 06 00         [ 7]  124     ld b, #0x00
   560F 09            [11]  125     add hl, bc
                            126 
   5610 5E            [ 7]  127     ld e, (hl)
   5611 23            [ 6]  128     inc hl
   5612 56            [ 7]  129     ld d, (hl)
                            130 
   5613 DD 6B               131     .db #0xDD, #0x6B        ;; OPCODE ld ixl, e
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 88.
Hexadecimal [16-Bits]



   5615 DD 62               132     .db #0xDD, #0x62        ;; OPCODE ld ixh, d
                            133 
                            134     ;; Incrementar contador
   5617 21 4B 7B      [10]  135     ld hl, #mi_num_interactable    
   561A 34            [11]  136     inc (hl)
                            137 
                            138     
   561B 2A 4C 7B      [16]  139     ld hl, (mi_next_interactable_l)
                            140 
   561E C1            [10]  141     pop bc
                            142 
                            ...
                            146 
   561F 70            [ 7]  147     ld (hl), b                  ;; _x
   5620 23            [ 6]  148     inc hl
   5621 71            [ 7]  149     ld (hl), c                  ;; _y
   5622 23            [ 6]  150     inc hl
                            151 
   5623 DD 7E 00      [19]  152     ld a, _eit_w(ix)            ;; _w
   5626 77            [ 7]  153     ld (hl), a
   5627 23            [ 6]  154     inc hl
                            155 
   5628 DD 7E 01      [19]  156     ld a, _eit_h(ix)            ;; _h
   562B 77            [ 7]  157     ld (hl), a
   562C 23            [ 6]  158     inc hl
                            159 
   562D 36 00         [10]  160     ld (hl), #0x00              ;; _vx
   562F 23            [ 6]  161     inc hl
                            162 
   5630 36 00         [10]  163     ld (hl), #0x00              ;; _vy
   5632 23            [ 6]  164     inc hl
                            165 
   5633 36 00         [10]  166     ld (hl), #0x00              ;; _offset
   5635 23            [ 6]  167     inc hl
                            168 
   5636 DD 7E 02      [19]  169     ld a, _eit_attributes(ix)   ;; _atributes
   5639 77            [ 7]  170     ld (hl), a
   563A 23            [ 6]  171     inc hl
                            172 
   563B DD 7E 03      [19]  173     ld a, _eit_spr_l(ix)        ;; _sprite_l
   563E 77            [ 7]  174     ld (hl), a
   563F 23            [ 6]  175     inc hl
                            176 
   5640 DD 7E 04      [19]  177     ld a, _eit_spr_h(ix)        ;; _sprite_h
   5643 77            [ 7]  178     ld (hl), a
   5644 23            [ 6]  179     inc hl
                            180 
   5645 DD 7E 05      [19]  181     ld a, _eit_spr_wi(ix)       ;; _sprite_wi
   5648 77            [ 7]  182     ld (hl), a
   5649 23            [ 6]  183     inc hl
                            184 
   564A DD 7E 06      [19]  185     ld a, _eit_spr_he(ix)       ;; _sprite_he
   564D 77            [ 7]  186     ld (hl), a
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 89.
Hexadecimal [16-Bits]



   564E 23            [ 6]  187     inc hl
                            188 
   564F DD 7E 07      [19]  189     ld a, _eit_spr_size(ix)     ;; _sprite_size
   5652 77            [ 7]  190     ld (hl), a
   5653 23            [ 6]  191     inc hl
                            192 
   5654 70            [ 7]  193     ld (hl), b                  ;; _prev_x
   5655 23            [ 6]  194     inc hl
                            195 
   5656 71            [ 7]  196     ld (hl), c                  ;; _prev_y
   5657 23            [ 6]  197     inc hl
                            198 
   5658 36 00         [10]  199     ld (hl), #0x00              ;; _prev_o
   565A 23            [ 6]  200     inc hl
                            201 
   565B DD 7E 08      [19]  202     ld a, _eit_spr_ox(ix)       ;; _ox
   565E 77            [ 7]  203     ld (hl), a
   565F 23            [ 6]  204     inc hl
                            205 
   5660 DD 7E 09      [19]  206     ld a, _eit_spr_oy(ix)       ;; _oy
   5663 77            [ 7]  207     ld (hl), a
   5664 23            [ 6]  208     inc hl
                            209     
   5665 DD 7E 0B      [19]  210     ld a, _eit_anim_ind_l(ix)   ;; _anim_index_l
   5668 77            [ 7]  211     ld (hl), a
   5669 23            [ 6]  212     inc hl
                            213 
   566A DD 7E 0A      [19]  214     ld a, _eit_anim_ind_h(ix)   ;; _anim_index_h
   566D 77            [ 7]  215     ld (hl), a
   566E 23            [ 6]  216     inc hl
                            217 
   566F 36 00         [10]  218     ld (hl), #0x00              ;; _anim_pos
   5671 23            [ 6]  219     inc hl
                            220 
   5672 36 00         [10]  221     ld (hl), #0x00              ;; _anim_dur
   5674 23            [ 6]  222     inc hl
                            223 
   5675 DD 7E 0C      [19]  224     ld a, _eit_score(ix)        ;; _score
   5678 77            [ 7]  225     ld (hl), a
   5679 23            [ 6]  226     inc hl
                            227 
   567A DD 7E 0D      [19]  228     ld a, _eit_type(ix)         ;; _type
   567D 77            [ 7]  229     ld (hl), a
   567E 23            [ 6]  230     inc hl
                            231 
   567F 36 00         [10]  232     ld (hl), #0x00              ;; _disabled
   5681 23            [ 6]  233     inc hl
                            234 
   5682 22 4C 7B      [16]  235     ld (mi_next_interactable_l), hl
                            236 
   5685 C9            [10]  237     ret
                            238 
                            239 
...
Hexadecimal [16-Bits]
                            ...
                            256 ;; CYCLES: [ | ]
                            257 ;;==================================================================
   5686                     258 _mi_remove_interactable:
                            259 
                            260     ;; Decrementar contador
   5686 21 4B 7B      [10]  261     ld hl, #mi_num_interactable    
   5689 35            [11]  262     dec (hl)
                            263 
   568A 2A 4C 7B      [16]  264     ld hl, (mi_next_interactable_l)
                            265 
   568D AF            [ 4]  266     xor a
   568E 47            [ 4]  267     ld b, a
   568F 05            [ 4]  268     dec b
   5690 D6 19         [ 7]  269     sub #_ei_size
   5692 4F            [ 4]  270     ld c, a
   5693 09            [11]  271     add hl, bc
                            272 
   5694 22 4C 7B      [16]  273     ld (mi_next_interactable_l), hl
                            274 
   5697 04            [ 4]  275     inc b
   5698 0E 19         [ 7]  276     ld c, #_ei_size
                            277 
                            ...
                            281 
                            282     
   569A A7            [ 4]  283     and a      ;; Carry flag -> 0
   569B ED 52         [15]  284     sbc hl, de ;; Si se elimina el último elemento no es necesario hacer ldir
   569D C8            [11]  285     ret z
                            286 
   569E 2A 4C 7B      [16]  287     ld hl, (mi_next_interactable_l)
                            288 
   56A1 ED B0         [21]  289     ldir
                            290 
   56A3 C9            [10]  291     ret
