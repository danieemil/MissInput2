...
Hexadecimal [16-Bits]
                              ...
                              1 .include "man/manager_enemy.h.s"
                              1 ;;DEPENDENCIAS
...
Hexadecimal [16-Bits]
                              ...
                              2 
                              3 .macro DefineEnemyVector _me_name, _n
                              4     _c = 0
                              5     .rept _n
                              6         DefineEnemyDefault _me_name, \_c
                              7         _c = _c + 1
                              8     .endm
                              9 .endm
                             10 
                             ...
                             12 .area _DATA
                             13 
   7B4E                      14 enemy_vector:: DefineEnemyVector enemy_vector, 10
                     0000     1     _c = 0
                              2     .rept 10
                              3         DefineEnemyDefault enemy_vector, \_c
                              4         _c = _c + 1
                              5     .endm
   7B4E                       1         DefineEnemyDefault enemy_vector, \_c
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7B4E                       2     DefineEntityEnemy enemy_vector0, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
   0000                       1 enemy_vector0:
   0000                       2     DefineEntityDrawable enemy_vector0_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
   0000                       1 enemy_vector0_ed:
   0000                       2     DefineEntityPhysics enemy_vector0_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   0000                       2     enemy_vector0_ed_eph:
   7B4E 00 00                 3     .db 0x00, 0x00
   7B50 02 08                 4     .db 0x02, 0x08
   7B52 00 00                 5     .db 0x00, 0x00
   7B54 00                    6     .db #0x00           ;;Offset en X
   7B55 00                    7     .db 0b00000000
                     0008     8     enemy_vector0_ed_eph_size = . - enemy_vector0_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7B56 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7B58 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7B5A 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7B5B 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7B5D 00                    8     .db #0x00           ;; Previous Offset
   7B5E 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7B60 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7B62 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7B63 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector0_ed_size = . - enemy_vector0_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7B64 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7B65 00                    5     .db 0x00
   7B66 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7B67 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector0_size = . - enemy_vector0 ;; Saves the number of bytes that fills a DefineEntity
                     0001     2         _c = _c + 1
   7B69                       1         DefineEnemyDefault enemy_vector, \_c
...
Hexadecimal [16-Bits]
                              ...
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7B69                       2     DefineEntityEnemy enemy_vector1, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
   7B69                       1 enemy_vector1:
   001B                       2     DefineEntityDrawable enemy_vector1_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
   001B                       1 enemy_vector1_ed:
   001B                       2     DefineEntityPhysics enemy_vector1_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   001B                       2     enemy_vector1_ed_eph:
   7B69 00 00                 3     .db 0x00, 0x00
   7B6B 02 08                 4     .db 0x02, 0x08
   7B6D 00 00                 5     .db 0x00, 0x00
   7B6F 00                    6     .db #0x00           ;;Offset en X
   7B70 00                    7     .db 0b00000000
                     0008     8     enemy_vector1_ed_eph_size = . - enemy_vector1_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7B71 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7B73 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7B75 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7B76 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7B78 00                    8     .db #0x00           ;; Previous Offset
   7B79 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7B7B 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7B7D 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7B7E 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector1_ed_size = . - enemy_vector1_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7B7F 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7B80 00                    5     .db 0x00
   7B81 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7B82 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector1_size = . - enemy_vector1 ;; Saves the number of bytes that fills a DefineEntity
                     0002     2         _c = _c + 1
   7B84                       1         DefineEnemyDefault enemy_vector, \_c
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7B84                       2     DefineEntityEnemy enemy_vector2, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
   7B84                       1 enemy_vector2:
   0036                       2     DefineEntityDrawable enemy_vector2_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
   0036                       1 enemy_vector2_ed:
   0036                       2     DefineEntityPhysics enemy_vector2_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   0036                       2     enemy_vector2_ed_eph:
   7B84 00 00                 3     .db 0x00, 0x00
   7B86 02 08                 4     .db 0x02, 0x08
   7B88 00 00                 5     .db 0x00, 0x00
   7B8A 00                    6     .db #0x00           ;;Offset en X
   7B8B 00                    7     .db 0b00000000
                     0008     8     enemy_vector2_ed_eph_size = . - enemy_vector2_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7B8C 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7B8E 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7B90 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 83.
Hexadecimal [16-Bits]



   7B91 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7B93 00                    8     .db #0x00           ;; Previous Offset
   7B94 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7B96 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7B98 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7B99 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector2_ed_size = . - enemy_vector2_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7B9A 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7B9B 00                    5     .db 0x00
   7B9C 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7B9D 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector2_size = . - enemy_vector2 ;; Saves the number of bytes that fills a DefineEntity
                     0003     2         _c = _c + 1
   7B9F                       1         DefineEnemyDefault enemy_vector, \_c
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7B9F                       2     DefineEntityEnemy enemy_vector3, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
   7B9F                       1 enemy_vector3:
   0051                       2     DefineEntityDrawable enemy_vector3_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
   0051                       1 enemy_vector3_ed:
   0051                       2     DefineEntityPhysics enemy_vector3_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   0051                       2     enemy_vector3_ed_eph:
   7B9F 00 00                 3     .db 0x00, 0x00
   7BA1 02 08                 4     .db 0x02, 0x08
   7BA3 00 00                 5     .db 0x00, 0x00
   7BA5 00                    6     .db #0x00           ;;Offset en X
   7BA6 00                    7     .db 0b00000000
                     0008     8     enemy_vector3_ed_eph_size = . - enemy_vector3_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7BA7 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7BA9 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7BAB 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7BAC 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7BAE 00                    8     .db #0x00           ;; Previous Offset
   7BAF 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7BB1 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7BB3 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7BB4 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector3_ed_size = . - enemy_vector3_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7BB5 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7BB6 00                    5     .db 0x00
   7BB7 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7BB8 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector3_size = . - enemy_vector3 ;; Saves the number of bytes that fills a DefineEntity
                     0004     2         _c = _c + 1
   7BBA                       1         DefineEnemyDefault enemy_vector, \_c
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7BBA                       2     DefineEntityEnemy enemy_vector4, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 84.
Hexadecimal [16-Bits]



   7BBA                       1 enemy_vector4:
   006C                       2     DefineEntityDrawable enemy_vector4_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
   006C                       1 enemy_vector4_ed:
   006C                       2     DefineEntityPhysics enemy_vector4_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   006C                       2     enemy_vector4_ed_eph:
   7BBA 00 00                 3     .db 0x00, 0x00
   7BBC 02 08                 4     .db 0x02, 0x08
   7BBE 00 00                 5     .db 0x00, 0x00
   7BC0 00                    6     .db #0x00           ;;Offset en X
   7BC1 00                    7     .db 0b00000000
                     0008     8     enemy_vector4_ed_eph_size = . - enemy_vector4_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7BC2 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7BC4 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7BC6 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7BC7 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7BC9 00                    8     .db #0x00           ;; Previous Offset
   7BCA 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7BCC 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7BCE 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7BCF 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector4_ed_size = . - enemy_vector4_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7BD0 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7BD1 00                    5     .db 0x00
   7BD2 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7BD3 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector4_size = . - enemy_vector4 ;; Saves the number of bytes that fills a DefineEntity
                     0005     2         _c = _c + 1
   7BD5                       1         DefineEnemyDefault enemy_vector, \_c
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7BD5                       2     DefineEntityEnemy enemy_vector5, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
   7BD5                       1 enemy_vector5:
   0087                       2     DefineEntityDrawable enemy_vector5_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
   0087                       1 enemy_vector5_ed:
   0087                       2     DefineEntityPhysics enemy_vector5_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   0087                       2     enemy_vector5_ed_eph:
   7BD5 00 00                 3     .db 0x00, 0x00
   7BD7 02 08                 4     .db 0x02, 0x08
   7BD9 00 00                 5     .db 0x00, 0x00
   7BDB 00                    6     .db #0x00           ;;Offset en X
   7BDC 00                    7     .db 0b00000000
                     0008     8     enemy_vector5_ed_eph_size = . - enemy_vector5_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7BDD 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7BDF 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7BE1 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7BE2 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7BE4 00                    8     .db #0x00           ;; Previous Offset
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 85.
Hexadecimal [16-Bits]



   7BE5 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7BE7 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7BE9 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7BEA 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector5_ed_size = . - enemy_vector5_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7BEB 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7BEC 00                    5     .db 0x00
   7BED 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7BEE 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector5_size = . - enemy_vector5 ;; Saves the number of bytes that fills a DefineEntity
                     0006     2         _c = _c + 1
   7BF0                       1         DefineEnemyDefault enemy_vector, \_c
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7BF0                       2     DefineEntityEnemy enemy_vector6, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
   7BF0                       1 enemy_vector6:
   00A2                       2     DefineEntityDrawable enemy_vector6_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
   00A2                       1 enemy_vector6_ed:
   00A2                       2     DefineEntityPhysics enemy_vector6_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   00A2                       2     enemy_vector6_ed_eph:
   7BF0 00 00                 3     .db 0x00, 0x00
   7BF2 02 08                 4     .db 0x02, 0x08
   7BF4 00 00                 5     .db 0x00, 0x00
   7BF6 00                    6     .db #0x00           ;;Offset en X
   7BF7 00                    7     .db 0b00000000
                     0008     8     enemy_vector6_ed_eph_size = . - enemy_vector6_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7BF8 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7BFA 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7BFC 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7BFD 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7BFF 00                    8     .db #0x00           ;; Previous Offset
   7C00 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7C02 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7C04 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7C05 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector6_ed_size = . - enemy_vector6_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7C06 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7C07 00                    5     .db 0x00
   7C08 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7C09 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector6_size = . - enemy_vector6 ;; Saves the number of bytes that fills a DefineEntity
                     0007     2         _c = _c + 1
   7C0B                       1         DefineEnemyDefault enemy_vector, \_c
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7C0B                       2     DefineEntityEnemy enemy_vector7, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
   7C0B                       1 enemy_vector7:
   00BD                       2     DefineEntityDrawable enemy_vector7_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 86.
Hexadecimal [16-Bits]



   00BD                       1 enemy_vector7_ed:
   00BD                       2     DefineEntityPhysics enemy_vector7_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   00BD                       2     enemy_vector7_ed_eph:
   7C0B 00 00                 3     .db 0x00, 0x00
   7C0D 02 08                 4     .db 0x02, 0x08
   7C0F 00 00                 5     .db 0x00, 0x00
   7C11 00                    6     .db #0x00           ;;Offset en X
   7C12 00                    7     .db 0b00000000
                     0008     8     enemy_vector7_ed_eph_size = . - enemy_vector7_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7C13 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7C15 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7C17 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7C18 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7C1A 00                    8     .db #0x00           ;; Previous Offset
   7C1B 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7C1D 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7C1F 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7C20 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector7_ed_size = . - enemy_vector7_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7C21 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7C22 00                    5     .db 0x00
   7C23 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7C24 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector7_size = . - enemy_vector7 ;; Saves the number of bytes that fills a DefineEntity
                     0008     2         _c = _c + 1
   7C26                       1         DefineEnemyDefault enemy_vector, \_c
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7C26                       2     DefineEntityEnemy enemy_vector8, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
   7C26                       1 enemy_vector8:
   00D8                       2     DefineEntityDrawable enemy_vector8_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
   00D8                       1 enemy_vector8_ed:
   00D8                       2     DefineEntityPhysics enemy_vector8_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   00D8                       2     enemy_vector8_ed_eph:
   7C26 00 00                 3     .db 0x00, 0x00
   7C28 02 08                 4     .db 0x02, 0x08
   7C2A 00 00                 5     .db 0x00, 0x00
   7C2C 00                    6     .db #0x00           ;;Offset en X
   7C2D 00                    7     .db 0b00000000
                     0008     8     enemy_vector8_ed_eph_size = . - enemy_vector8_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7C2E 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7C30 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7C32 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7C33 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7C35 00                    8     .db #0x00           ;; Previous Offset
   7C36 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7C38 00 00                10     .dw 0x0000     ;; Puntero a la animación
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 87.
Hexadecimal [16-Bits]



   7C3A 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7C3B 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector8_ed_size = . - enemy_vector8_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7C3C 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7C3D 00                    5     .db 0x00
   7C3E 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7C3F 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector8_size = . - enemy_vector8 ;; Saves the number of bytes that fills a DefineEntity
                     0009     2         _c = _c + 1
   7C41                       1         DefineEnemyDefault enemy_vector, \_c
                              1 ;                                      x    y     w     h     vx    vy     attr      spr     sw     sh    ss    ox    oy   animi   type
   7C41                       2     DefineEntityEnemy enemy_vector9, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000, 0x00 
   7C41                       1 enemy_vector9:
   00F3                       2     DefineEntityDrawable enemy_vector9_ed, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000, 0x0000, 0x03, 0x08, 0x00, 0x00, 0x00, 0x0000
   00F3                       1 enemy_vector9_ed:
   00F3                       2     DefineEntityPhysics enemy_vector9_ed_eph, 0x00, 0x00, 0x02, 0x08, 0x00, 0x00, 0b00000000
                              1 
   00F3                       2     enemy_vector9_ed_eph:
   7C41 00 00                 3     .db 0x00, 0x00
   7C43 02 08                 4     .db 0x02, 0x08
   7C45 00 00                 5     .db 0x00, 0x00
   7C47 00                    6     .db #0x00           ;;Offset en X
   7C48 00                    7     .db 0b00000000
                     0008     8     enemy_vector9_ed_eph_size = . - enemy_vector9_ed_eph ;; Saves the number of bytes that fills a DefineEntity
                              9 
                              3     
   7C49 00 00                 4     .dw 0x0000         ;; Sprite ptr
   7C4B 03 08                 5     .db 0x03, 0x08  ;;Sprite Width/Height
   7C4D 00                    6     .db 0x00       ;; Sprite size [0, 48, 96, 144]
   7C4E 00 00                 7     .db 0x00, 0x00          ;; Previous x, y
   7C50 00                    8     .db #0x00           ;; Previous Offset
   7C51 00 00                 9     .db 0x00, 0x00        ;; Sprite Offset
   7C53 00 00                10     .dw 0x0000     ;; Puntero a la animación
   7C55 00                   11     .db #0x00           ;; Posición del sprite dentro de la animación
   7C56 00                   12     .db #0x00           ;; Duración de dibujado del sprite de la animación
                             13 
                     0016    14     enemy_vector9_ed_size = . - enemy_vector9_ed ;; Saves the number of bytes that fills a DefineEntity
                              3 
   7C57 00                    4     .db #0x00       ;;Offset de la tabla de saltos
   7C58 00                    5     .db 0x00
   7C59 00                    6     .db #0x00       ;; Ciclos que tiene que permanecer deshabilitado
   7C5A 00 00                 7     .db 0x00, 0x00      ;; Posición origen del enemigo
                              8 
                     001B     9     enemy_vector9_size = . - enemy_vector9 ;; Saves the number of bytes that fills a DefineEntity
                     000A     2         _c = _c + 1
   7C5C 00                   15 me_num_enemy:: .db #00
   7C5D 00                   16 me_next_enemy_l: .db #00
   7C5E 00                   17 me_next_enemy_h: .db #00
                             18 
                             19 
                             20 .area _CODE
                             21 
...
Hexadecimal [16-Bits]
                             ...
                             22 ;;==================================================================
                             23 ;;                       INIT ENEMY VECTOR
                             24 ;;------------------------------------------------------------------
                             25 ;; Inicializa los datos del vector de enemigos
                             26 ;;------------------------------------------------------------------
                             27 ;;
                             28 ;; INPUT:
                             29 ;;  NONE
                             ...
                             38 ;; CYCLES: [ | ]
                             39 ;;==================================================================
   56A4                      40 _me_init_vector:
                             41     
   56A4 21 5C 7C      [10]   42     ld hl, #me_num_enemy
   56A7 36 00         [10]   43     ld (hl), #0x00
                             44 
   56A9 21 4E 7B      [10]   45     ld hl, #enemy_vector
   56AC 22 5D 7C      [16]   46     ld (me_next_enemy_l), hl
                             47 
   56AF C9            [10]   48     ret
                             49 
                             50 
                             ...
                             52 ;;                       ADD ENEMY
                             53 ;;------------------------------------------------------------------
                             54 ;; Añade un enemigo del vector de enemigos y los datos del vector
                             55 ;;------------------------------------------------------------------
                             56 ;;
                             57 ;; INPUT:
                             58 ;;  A   -> Tipo de enemigo
                             59 ;;  BC  -> Position X, Y
                             60 ;;  DE  -> Velocity X, Y
                             61 ;;      
                             62 ;; OUTPUT:
                             ...
                             69 ;; CYCLES: [ | ]
                             70 ;;==================================================================
   56B0                      71 _me_add_enemy:
                             72     
   56B0 C5            [11]   73     push bc
   56B1 D5            [11]   74     push de
                             75 
   56B2 21 2E 79      [10]   76     ld hl, #enemy_index
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 89.
Hexadecimal [16-Bits]



   56B5 CB 27         [ 8]   77     sla a
                             78 
   56B7 4F            [ 4]   79     ld c, a
   56B8 06 00         [ 7]   80     ld b, #0x00
   56BA 09            [11]   81     add hl, bc
                             82 
   56BB 5E            [ 7]   83     ld e, (hl)
   56BC 23            [ 6]   84     inc hl
   56BD 56            [ 7]   85     ld d, (hl)
                             86 
   56BE DD 6B                87     .db #0xDD, #0x6B        ;; OPCODE ld ixl, e
   56C0 DD 62                88     .db #0xDD, #0x62        ;; OPCODE ld ixh, d
                             89 
                             90     ;; Incrementar contador
   56C2 21 5C 7C      [10]   91     ld hl, #me_num_enemy    
   56C5 34            [11]   92     inc (hl)
                             93 
                             94     
   56C6 2A 5D 7C      [16]   95     ld hl, (me_next_enemy_l)
                             96 
   56C9 D1            [10]   97     pop de
   56CA C1            [10]   98     pop bc
                             99 
                            100     ;; IX -> Puntero a los datos característicos del tipo de enemigo
                            101     ;; HL -> Puntero a donde hay que copiar los datos
                            102     ;; BC -> Posición del enemigo
                            103     ;; DE -> Velocidad inicial del enemigo
                            104 
   56CB 70            [ 7]  105     ld (hl), b                  ;; _x
   56CC 23            [ 6]  106     inc hl
                            107     
   56CD 71            [ 7]  108     ld (hl), c                  ;; _y
   56CE 23            [ 6]  109     inc hl
                            110 
   56CF DD 7E 00      [19]  111     ld a, _eet_w(ix)            ;; _w
   56D2 77            [ 7]  112     ld (hl), a
   56D3 23            [ 6]  113     inc hl
                            114 
   56D4 DD 7E 01      [19]  115     ld a, _eet_h(ix)            ;; _h
   56D7 77            [ 7]  116     ld (hl), a
   56D8 23            [ 6]  117     inc hl
                            118 
   56D9 72            [ 7]  119     ld (hl), d                  ;; _vx
   56DA 23            [ 6]  120     inc hl
                            121 
   56DB 73            [ 7]  122     ld (hl), e                  ;; _vy
   56DC 23            [ 6]  123     inc hl
                            124 
   56DD 36 00         [10]  125     ld (hl), #0x00              ;; _offset
   56DF 23            [ 6]  126     inc hl
                            127 
   56E0 DD 7E 02      [19]  128     ld a, _eet_attributes(ix)   ;; _attributes
   56E3 77            [ 7]  129     ld (hl), a
   56E4 23            [ 6]  130     inc hl
                            131 
...
Hexadecimal [16-Bits]
   ...
   56E5 DD 7E 03      [19]  132     ld a, _eet_spr_l(ix)        ;; _sprite_l
   56E8 77            [ 7]  133     ld (hl), a
   56E9 23            [ 6]  134     inc hl
                            135 
   56EA DD 7E 04      [19]  136     ld a, _eet_spr_h(ix)        ;; _sprite_h
   56ED 77            [ 7]  137     ld (hl), a
   56EE 23            [ 6]  138     inc hl
                            139 
   56EF DD 7E 05      [19]  140     ld a, _eet_spr_wi(ix)       ;; _sprite_wi
   56F2 77            [ 7]  141     ld (hl), a
   56F3 23            [ 6]  142     inc hl
                            143 
   56F4 DD 7E 06      [19]  144     ld a, _eet_spr_he(ix)       ;; _sprite_he
   56F7 77            [ 7]  145     ld (hl), a
   56F8 23            [ 6]  146     inc hl
                            147 
   56F9 DD 7E 07      [19]  148     ld a, _eet_spr_size(ix)     ;; _sprite_size
   56FC 77            [ 7]  149     ld (hl), a
   56FD 23            [ 6]  150     inc hl
                            151 
   56FE 70            [ 7]  152     ld (hl), b                  ;; _prev_x
   56FF 23            [ 6]  153     inc hl
                            154 
   5700 71            [ 7]  155     ld (hl), c                  ;; _prev_y
   5701 23            [ 6]  156     inc hl
                            157 
   5702 36 00         [10]  158     ld (hl), #0x00              ;; _prev_o
   5704 23            [ 6]  159     inc hl
                            160 
   5705 DD 7E 08      [19]  161     ld a, _eet_spr_ox(ix)       ;; _ox
   5708 77            [ 7]  162     ld (hl), a
   5709 23            [ 6]  163     inc hl
                            164 
   570A DD 7E 09      [19]  165     ld a, _eet_spr_oy(ix)       ;; _oy
   570D 77            [ 7]  166     ld (hl), a
   570E 23            [ 6]  167     inc hl
                            168 
   570F DD 7E 0B      [19]  169     ld a, _eet_anim_ind_l(ix)   ;; _anim_index_l
   5712 77            [ 7]  170     ld (hl), a
   5713 23            [ 6]  171     inc hl
                            172 
   5714 DD 7E 0A      [19]  173     ld a, _eet_anim_ind_h(ix)   ;; _anim_index_h
   5717 77            [ 7]  174     ld (hl), a
   5718 23            [ 6]  175     inc hl
                            176 
   5719 36 00         [10]  177     ld (hl), #0x00              ;; _anim_pos
   571B 23            [ 6]  178     inc hl
                            179 
   571C 36 00         [10]  180     ld (hl), #0x00              ;; _anim_dur
   571E 23            [ 6]  181     inc hl
                            182 
   571F 36 0E         [10]  183     ld (hl), #JT_ON_GROUND      ;; _offset_Jump_Table
   5721 23            [ 6]  184     inc hl
                            185 
   5722 DD 7E 0C      [19]  186     ld a, _eet_type(ix)         ;; _type
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 91.
Hexadecimal [16-Bits]



   5725 77            [ 7]  187     ld (hl), a
   5726 23            [ 6]  188     inc hl
                            189 
   5727 36 00         [10]  190     ld (hl), #0x00              ;; _disabled
   5729 23            [ 6]  191     inc hl
                            192 
   572A 70            [ 7]  193     ld (hl), b                  ;; _origin_x
   572B 23            [ 6]  194     inc hl
                            195 
   572C 71            [ 7]  196     ld (hl), c                  ;; _origin_y
   572D 23            [ 6]  197     inc hl
                            198 
   572E 22 5D 7C      [16]  199     ld (me_next_enemy_l), hl
                            200 
   5731 C9            [10]  201     ret
                            202 
                            203 
                            ...
                            205 ;;                       REMOVE ENEMY
                            206 ;;------------------------------------------------------------------
                            207 ;; Quita a un enemigo del vector de enemigos y los datos del vector
                            208 ;;------------------------------------------------------------------
                            209 ;;
                            210 ;; INPUT:
                            211 ;;  DE -> Puntero al enemigo que quitar
                            212 ;;      
                            213 ;; OUTPUT:
                            214 ;;  NONE
                            215 ;;
                            ...
                            220 ;; CYCLES: [ | ]
                            221 ;;==================================================================
   5732                     222 _me_remove_enemy:
                            223 
                            224     ;; Decrementar contador
   5732 21 5C 7C      [10]  225     ld hl, #me_num_enemy    
   5735 35            [11]  226     dec (hl)
                            227 
   5736 2A 5D 7C      [16]  228     ld hl, (me_next_enemy_l)
                            229 
   5739 AF            [ 4]  230     xor a
   573A 47            [ 4]  231     ld b, a
   573B 05            [ 4]  232     dec b
   573C D6 1B         [ 7]  233     sub #_ee_size
   573E 4F            [ 4]  234     ld c, a
   573F 09            [11]  235     add hl, bc
                            236 
   5740 22 5D 7C      [16]  237     ld (me_next_enemy_l), hl
                            238 
   5743 04            [ 4]  239     inc b
   5744 0E 1B         [ 7]  240     ld c, #_ee_size
                            241 
...
Hexadecimal [16-Bits]
                            ...
                            242     ;; HL -> Puntero al último elemento del array
                            243     ;; DE -> Puntero al elemento a borrar del array
                            244     ;; BC -> Tamaño un elemento del vector
                            245 
                            246     
   5746 A7            [ 4]  247     and a      ;; Carry flag -> 0
   5747 ED 52         [15]  248     sbc hl, de ;; Si se elimina el último elemento no es necesario hacer ldir
   5749 C8            [11]  249     ret z
                            250 
   574A 2A 5D 7C      [16]  251     ld hl, (me_next_enemy_l)
                            252 
   574D ED B0         [21]  253     ldir
                            254 
   574F C9            [10]  255     ret
